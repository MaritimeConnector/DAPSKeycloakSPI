...
public class DAPSClientAuthenticator extends AbstractClientAuthenticator {

    private static final Logger logger = Logger.getLogger(DAPSClientAuthenticator.class);
    ...
    public void authenticateClient(ClientAuthenticationFlowContext context) {
        ...
        logger.error("AUTHENTICATION START");
        ...
        try {
            ...
            // TODO maybe that breaks everything who knows
    ...
    private List<String> getExpectedAudiences(ClientAuthenticationFlowContext context, RealmModel realm) {
        ...
        expectedAudiences.add("idsc:IDS_CONNECTORS_ALL");
